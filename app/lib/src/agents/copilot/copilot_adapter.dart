...
// capability behind the common [AgentAdapter] contract. Image attachment,
// native transcript history, and structured prompts are not implemented for
// Copilot yet — those capabilities are left at the [AgentAdapter] defaults
// (null), so AgentScreen falls back to its generic pane-text/numbered-prompt
// behavior for them.
