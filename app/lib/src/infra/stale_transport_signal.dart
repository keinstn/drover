...
///
/// Owns [_network]: [dispose] disposes it too, so callers must not also
...
class StaleTransportSignal {
  ...
  /// Cancels the pending debounce timer, disposes [_network], and closes
  /// [changes]. Callers must not dispose the [NetworkChangeSignal] they
  /// passed in separately — this owns it.
