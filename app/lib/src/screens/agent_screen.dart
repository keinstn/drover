    ...
    return Scaffold(
              ...
              children: [
                ...
                if (agent != null)
                  Chip(
                    ...
                    label: Text(
                      '${agent.status.name} · ${widget.paneId} · '
                      '${agent.workspaceId}',
                    ),
                  ),
              ],
      ...
      body: Column(
        children: [
          ...
          if (question != null) _PromptCard(question: question, onSend: _send, client: widget.client, paneId: widget.paneId),
          _QuickChipsRow(sending: _sending, onSend: _send, client: widget.client, paneId: widget.paneId),
          _Composer(
