...
abstract class AppLocalizations {
  ...
  /// No description provided for @voiceBackgrounded.
  ///
  /// In en, this message translates to:
  /// **'App went to the background'**
  String get voiceBackgrounded;
